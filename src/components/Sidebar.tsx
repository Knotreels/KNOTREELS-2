  ...
  return (
    <>
      ...
      <aside
        ...
        className={`
          sticky top-0 h-screen bg-white p-4 z-50
      ...
      >
          ...
          <Link href="/dashboard/orin">
            <div className="relative w-full h-40 mb-4 rounded-xl overflow-hidden shadow-lg group transition hover:shadow-[0_0_20px_4px_rgba(59,130,246,0.8)]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-3">
                ...
                <p className="text-xs text-primary/60">Step into the cinematic saga</p>
              </div>
            </div>
          </Link>
        )}
        ...
        <div className="flex-1 overflow-y-hidden hover:overflow-y-auto pr-1 space-y-4 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-zinc-900">
          ...
          {!collapsed && (
            <div className="mb-4">
              <input
                ...
                className="w-full p-2 rounded bg-zinc-800 text-white placeholder-primary/50 focus:ring-2 focus:ring-primary"
              />
            </div>
          )}
          ...
          <div className="space-y-2">
            {!collapsed && (
              <h3 className="text-xs font-bold uppercase text-primary/70 tracking-wide mt-6">
                Monetization
              </h3>
            )}
            <button
          ...
          <div className="mt-6">
            {!collapsed && (
              <Link
                href="/terms"
                onClick={onClose}
                className="flex items-center gap-2 text-xs text-primary/60 hover:text-primary"
              >
                Terms & Conditions
              </Link>
            )}
          ...
          <button
            ...
            className="flex items-center gap-2 mt-2 text-xs text-red-400 hover:text-primary transition"
          >
            {!collapsed && 'Sign Out'}
          </button>
        </div>
